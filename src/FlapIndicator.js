...
const frameNumbers = [1, 2, 3, 4, 5]
const pointerLengths = [ARROW_LENGTH, 20, 30, 39, 49]
const rotations = [0, -5, -14, -25, -34]
...
class FlapIndicator extends Component {
  render() {
    const {
      frame,
      offset,
